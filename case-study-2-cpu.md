...
```
Calculating -------------------------------------
       Process 0.5Mb     18.014  (±11.1%) i/s -     90.000  in   5.034455s
       Process 1.0Mb      8.435  (±11.9%) i/s -     42.000  in   5.078297s
       Process 1.5Mb      5.186  (± 0.0%) i/s -     26.000  in   5.033557s
       Process 2.0Mb      3.562  (±28.1%) i/s -     17.000  in   5.087188s
       Process 2.5Mb      2.749  (± 0.0%) i/s -     14.000  in   5.268668s
       Process 3.0Mb      1.999  (± 0.0%) i/s -     10.000  in   5.119194s
       Process 3.5Mb      2.053  (± 0.0%) i/s -     11.000  in   5.391627s
       Process 4.0Mb      1.656  (± 0.0%) i/s -      9.000  in   5.526998s
       Process 4.5Mb      1.560  (± 0.0%) i/s -      8.000  in   5.258063s
       Process 5.0Mb      1.364  (± 0.0%) i/s -      7.000  in   5.188167s

Comparison:
       Process 0.5Mb:       18.0 i/s
       Process 1.0Mb:        8.4 i/s - 2.14x  slower
       Process 1.5Mb:        5.2 i/s - 3.47x  slower
       Process 2.0Mb:        3.6 i/s - 5.06x  slower
       Process 2.5Mb:        2.7 i/s - 6.55x  slower
       Process 3.5Mb:        2.1 i/s - 8.77x  slower
       Process 3.0Mb:        2.0 i/s - 9.01x  slower
       Process 4.0Mb:        1.7 i/s - 10.88x  slower
       Process 4.5Mb:        1.6 i/s - 11.55x  slower
       Process 5.0Mb:        1.4 i/s - 13.21x  slower
```
